...
echo ${base64_file} | base64 -d > /${module_name}/keyfiles/${chainbridge_pubkey}.key --ignore-garbage
...
-v /${module_name}/keyfiles/${chainbridge_pubkey}.key:/keys/${chainbridge_pubkey}.key \
